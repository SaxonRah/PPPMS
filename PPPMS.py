...
# ----- Hosts
# Will, Kevin, Nigel, Alan, Jabril, Peter, Bernard

# ----- Patron CSV
# Below is everything from a single line on the Patreon CSV file.
# It contains everything we need, I think.
# --- CSV File
...
# Every 3 months a filtered address list with the correct number of polaroids can go to the shippers.
...
# --- Every 3 Months - All Hosts?
# Each of the 7 Hosts take like one hundred photos and photos get mailed in round robin fashion.
